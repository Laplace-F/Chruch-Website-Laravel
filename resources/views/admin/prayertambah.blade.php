                ...
                <div class="col-12">
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        <div class="col-12 alert">
                            <h3 class="fw-bold text-center">Prayer Request</h3>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form method="post" action="{{ route('simpanrequestprayer') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="p-3 bg-secondary-subtle bg-opacity-10 border border-secondary border-start-0 rounded-end">
                                    <h6><b>Tambahkan Request Prayer</b></h6>
                                </div>
                                <br>

                                <div class="form-group row mb-3">
                                    <label for="name" class="col-sm-12 col-md-2 col-form-label fw-semibold">Nama</label>
                                ...
                                <div class="form-group row mb-3">
                                    <label for="phonenumber" class="col-sm-12 col-md-2 col-form-label fw-semibold">No Handphone</label>
                                    <div class="col-sm-12 col-md-10">
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-sm-12 col-md-10">
                                        <textarea class="form-control @error('hopepray') is-invalid @enderror"
                                                  id="hopepray" name="hopepray" rows="5"
                                                  placeholder="Masukkan Hope Pray" required>{{ old('hopepray') }}</textarea>
                                        @error('hopepray')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-sm-12 col-md-10">
                                        <textarea class="form-control @error('answerpray') is-invalid @enderror"
                                                  id="answerpray" name="answerpray" rows="5"
                                                  placeholder="Masukkan answer Pray" required>{{ old('answerpray') }}</textarea>
                                        @error('answerpray')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
