    ...
    <div class="page-inner">
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <form method="post" action="{{ url('admin/kegiatansimpan') }}" enctype="multipart/form-data">
                            @csrf
                            <div
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-10">
                                    <input type="text" class="form-control" name="judulkegiatan" required
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-10">
                                    <input type="date" class="form-control" name="tanggalkegiatan" required>
                                </div>
                            </div>
                            <br>
                            <div class="form-group row">
